...
After saving your authentification credentials as an .rdata file, you can start the application with the ```liveSentiment()``` call and select your ```<my_oauth>.rdata file in the ```Authentification?``` tab.
